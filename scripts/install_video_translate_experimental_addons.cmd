...
"%RUNTIME_PYTHON%" "%SCRIPT_DIR%setup_video_translate_runtime.py" --runtime-python "%RUNTIME_PYTHON%" --profile none --upgrade-pip --with-experimental-addons --restore-core-after-experimental
