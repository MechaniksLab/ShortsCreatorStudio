...
"%RUNTIME_PYTHON%" "%SCRIPT_DIR%setup_video_translate_runtime.py" --runtime-python "%RUNTIME_PYTHON%" --profile gpu-cu128 --upgrade-pip --with-uvr-models --with-rvc-native
