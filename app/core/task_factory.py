...
class TaskFactory:
    ...
    def create_video_translate_task(video_path: str) -> VideoTranslateTask:
        ...
        vt_cfg = VideoTranslateConfig(
            ...
            segment_fit_tail_guard_ms=cfg.video_translate_segment_fit_tail_guard_ms.value,
            segment_fit_max_speedup=cfg.video_translate_segment_fit_max_speedup.value,
            rvc_passthrough_post_pad_ms=cfg.video_translate_rvc_passthrough_post_pad_ms.value,
            speaker_chunk_max_gap_ms=cfg.video_translate_speaker_chunk_max_gap_ms.value,
            speaker_chunk_max_chunk_ms=cfg.video_translate_speaker_chunk_max_chunk_ms.value,
            rvc_passthrough_chunk_max_gap_ms=cfg.video_translate_rvc_passthrough_chunk_max_gap_ms.value,
            rvc_passthrough_chunk_max_chunk_ms=cfg.video_translate_rvc_passthrough_chunk_max_chunk_ms.value,
            schedule_min_gap_ms=cfg.video_translate_schedule_min_gap_ms.value,
            schedule_max_shift_ms=cfg.video_translate_schedule_max_shift_ms.value,
            schedule_overlap_tolerance_ms=cfg.video_translate_schedule_overlap_tolerance_ms.value,
            schedule_effective_duration_extra_ms=cfg.video_translate_schedule_effective_duration_extra_ms.value,
